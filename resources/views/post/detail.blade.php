                    ...
                    <div class="row">
                        ...
                        <div class="detail">
                                    ...
                                    @if (Auth::check())
                                        @if(Auth::id() == $postDetail->user_id)
                                            <div class="button-approve">
                                                ...
                                                @endif
                                                <a class="approve_active edit-post" href="{{ route('post.edit',['id' => $postDetail->id]) }}">Edit
                                                    blog</a>
                            ...
                            <div class="image-post">
                                <img src="{{ Vite::asset("public/images/").$postDetail->image }}" alt="{{ $postDetail->title }}">
                            </div>
                            <div class="content">{!! $postDetail->content !!}</div>
                            <div class="relase-heart">Thả Tim</div>
                        </div>
                        @if($postRelated)
                            <div class="related">
                                ...
                                <div class="row user-commit">
                                    ...
                                    <div class="content">
                                        <div class="content-card">
                                            ...
                                            <div class="comment-user">Yes, it’s right</div>
