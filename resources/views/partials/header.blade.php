<header>
    @if(Route::is('home') || Route::is('seach-by-title') || Route::is('seach-by-category') || Route::is('myblog'))
            ...
            <div class="row">
                ...
                <div class="header-right">
                    ...
                    <div class="form-search">
                        <form action={{ route('seach-by-title') }} method="GET">
                            <input type="text" placeholder="Search blog" class="news-search" name="title"/>
                            <button>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="19"
                ...
                <div class="header-left">
                    ...
                    @if(Auth::check())
                        <a @if(Route::is('post-create')) class="active" @else href="{{ route('post.create') }}" @endif>Create
                            Blog</a>
                        <div class="login">
                            <a id="login-click"><span>{{ Auth::user()->name }}</span>
                            ...
                            <div class="menu-profile">
                                <ul class="menu-profile-list">
                                    <li class="menu-profile-item">
                                        <a class="menu-profile-item-link" id="logout">Logout</a>
                                    </li>
                                    @if (Auth::user()->role === \App\Models\User::ROLE_ADMIN)
                                        <li class="menu-profile-item">
                                            <a href class="menu-profile-item-link">Admin</a>
                                        </li>
                                    @else
                                        <li class="menu-profile-item">
                                            <a href="{{ route('myblog') }}" class="menu-profile-item-link">My blogs</a>
                                        </li>
                                        <li class="menu-profile-item">
                                            <a href class="menu-profile-item-link">Profile</a>
                                        </li>
                                    @endif
                                </ul>
                            </div>
                    ...
                    @else
                        <a href="{{ route('login') }}" class="left-login">Login</a>
                        <a href="{{ route('register') }}" class="left-sign-up">Sign up</a>
                    @endif
                </div>
