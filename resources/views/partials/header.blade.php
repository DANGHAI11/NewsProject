        ...
        <div class="row">
          ...
          <div class="header-right">
            ...
            <div class="form-search">
              <form action>
                <input type="text" placeholder="Search blog" class="news-search" />
                <button>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="19"
          ...
          <div class="header-left">
            ...
            @if(Auth::check())
            <a @if(Route::is('post-create')) class="active" @else href="{{ route('post-create') }}"  @endif>Create Blog</a>
            <div class="login">
              <a href
              ...
              <div class="menu-profile">
                <ul class="menu-profile-list">
                  ...
                  @else
                    <li class="menu-profile-item">
                      <a href class="menu-profile-item-link">My blogs</a>
                    </li>
                    <li class="menu-profile-item">
